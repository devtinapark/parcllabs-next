...
export const SIZE_CONFIG = {
    ...
    instagram_square: { height: 1080, width: 1080 },
...
export const generateAnnotation = (
    kwargs: Partial<typeof STYLING_CONFIG.default_annotation_styling>
) => {
    return { ...STYLING_CONFIG.default_annotation_styling, ...kwargs };
};
